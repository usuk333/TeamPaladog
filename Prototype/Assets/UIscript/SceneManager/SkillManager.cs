...
public class SkillManager : MonoBehaviour
{
    ...
    private string[] skillNameArray = { "아무거나 맞아라!", "보호의 물약", "치유의 물약", "사기진작" };
    private string[] skillPathArray = { "Attack", "Barrior", "Heal", "PowerUp"};

    private int currentSkill = -1;

    private void Start()
    {
        goldText.text = GameManager.Instance.FirebaseData.InfoDictionary["Gold"].ToString();
